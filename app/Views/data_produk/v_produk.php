            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="simpanProduk" class="btn btn-secondary float-end">Simpan</button>
                    </div>
                </div>
            </div>
        </div>     
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formProduk">
                                ...
                                <button type="button" class="btn btn-secondary" id="editProdukSimpan">Simpan Perubahan</button>
                            </form>
                        </div>
                    </div> 
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                var produkTable = $('#produkTable tbody');
                                produkTable.empty();
                                // response.produk.forEach(function(item, index) {
                                //     var imagePath = item.image ? '<?= base_url("uploads") ?>/' + item.image : '';
                                //     var row = '<tr>' +
                                //         '<td>' + (index + 1) + '</td>' +
                                // })
                            }
